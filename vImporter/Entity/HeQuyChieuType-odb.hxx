...
#ifndef HE_QUY_CHIEU_TYPE_ODB_HXX
#define HE_QUY_CHIEU_TYPE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::HeQuyChieuType >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::HeQuyChieuType >
  {
    public:
    typedef ::HeQuyChieuType object_type;
    typedef ::std::shared_ptr< ::HeQuyChieuType > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct query_columns< ::HeQuyChieuType, id_oracle, A >
  {
    // mHeQuyChieuTypeId
    //
    typedef
    oracle::query_column<
      ...
      oracle::id_big_int >
    mHeQuyChieuTypeId_type_;

    static const mHeQuyChieuTypeId_type_ mHeQuyChieuTypeId;
  ...
  template <typename A>
  const typename query_columns< ::HeQuyChieuType, id_oracle, A >::mHeQuyChieuTypeId_type_
  query_columns< ::HeQuyChieuType, id_oracle, A >::
  mHeQuyChieuTypeId (A::table_name, "\"HEQUYCHIEUTYPEID\"", 0, 20);

  template <typename A>
  const typename query_columns< ::HeQuyChieuType, id_oracle, A >::mMa_type_
  query_columns< ::HeQuyChieuType, id_oracle, A >::
  mMa (A::table_name, "\"MA\"", 0, 200);

  template <typename A>
  const typename query_columns< ::HeQuyChieuType, id_oracle, A >::mMoTa_type_
  query_columns< ::HeQuyChieuType, id_oracle, A >::
  mMoTa (A::table_name, "\"MOTA\"", 0, 200);

  template <typename A>
  const typename query_columns< ::HeQuyChieuType, id_oracle, A >::mNguoiSuaId_type_
  query_columns< ::HeQuyChieuType, id_oracle, A >::
  mNguoiSuaId (A::table_name, "\"NGUOISUAID\"", 0, 20);

  template <typename A>
  const typename query_columns< ::HeQuyChieuType, id_oracle, A >::mNgayChinhSua_type_
  query_columns< ::HeQuyChieuType, id_oracle, A >::
  mNgayChinhSua (A::table_name, "\"NGAYCHINHSUA\"", 0);

  template <typename A>
  const typename query_columns< ::HeQuyChieuType, id_oracle, A >::mTrangThai_type_
  query_columns< ::HeQuyChieuType, id_oracle, A >::
  mTrangThai (A::table_name, "\"TRANGTHAI\"", 0, 1);

  template <typename A>
  struct pointer_query_columns< ::HeQuyChieuType, id_oracle, A >:
    query_columns< ::HeQuyChieuType, id_oracle, A >
  {
  };

  template <>
  class access::object_traits_impl< ::HeQuyChieuType, id_oracle >:
    public access::object_traits< ::HeQuyChieuType >
  {
    public:
    ...
    struct image_type
    {
      // mHeQuyChieuTypeId
      //
      char mHeQuyChieuTypeId_value[12];
      ub2 mHeQuyChieuTypeId_size;
      sb2 mHeQuyChieuTypeId_indicator;
  ...
  template <>
  class access::object_traits_impl< ::HeQuyChieuType, id_common >:
    public access::object_traits_impl< ::HeQuyChieuType, id_oracle >
  {
  };
...
#include "HeQuyChieuType-odb.ixx"

#include <odb/post.hxx>

#endif // HE_QUY_CHIEU_TYPE_ODB_HXX
