...
#ifndef PHUONG_PHAP_TLTYPE_ODB_HXX
#define PHUONG_PHAP_TLTYPE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::PhuongPhapTLType >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::PhuongPhapTLType >
  {
    public:
    typedef ::PhuongPhapTLType object_type;
    typedef ::std::shared_ptr< ::PhuongPhapTLType > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct query_columns< ::PhuongPhapTLType, id_oracle, A >
  {
    // mPhuongPhapTLTypeId
    //
    typedef
    oracle::query_column<
      ...
      oracle::id_big_int >
    mPhuongPhapTLTypeId_type_;

    static const mPhuongPhapTLTypeId_type_ mPhuongPhapTLTypeId;
  ...
  template <typename A>
  const typename query_columns< ::PhuongPhapTLType, id_oracle, A >::mPhuongPhapTLTypeId_type_
  query_columns< ::PhuongPhapTLType, id_oracle, A >::
  mPhuongPhapTLTypeId (A::table_name, "\"PHUONGPHAPTLTYPEID\"", 0, 20);

  template <typename A>
  const typename query_columns< ::PhuongPhapTLType, id_oracle, A >::mMa_type_
  query_columns< ::PhuongPhapTLType, id_oracle, A >::
  mMa (A::table_name, "\"MA\"", 0, 200);

  template <typename A>
  const typename query_columns< ::PhuongPhapTLType, id_oracle, A >::mMoTa_type_
  query_columns< ::PhuongPhapTLType, id_oracle, A >::
  mMoTa (A::table_name, "\"MOTA\"", 0, 200);

  template <typename A>
  const typename query_columns< ::PhuongPhapTLType, id_oracle, A >::mNguoiSuaId_type_
  query_columns< ::PhuongPhapTLType, id_oracle, A >::
  mNguoiSuaId (A::table_name, "\"NGUOISUAID\"", 0, 20);

  template <typename A>
  const typename query_columns< ::PhuongPhapTLType, id_oracle, A >::mNgayChinhSua_type_
  query_columns< ::PhuongPhapTLType, id_oracle, A >::
  mNgayChinhSua (A::table_name, "\"NGAYCHINHSUA\"", 0);

  template <typename A>
  const typename query_columns< ::PhuongPhapTLType, id_oracle, A >::mTrangThai_type_
  query_columns< ::PhuongPhapTLType, id_oracle, A >::
  mTrangThai (A::table_name, "\"TRANGTHAI\"", 0, 1);

  template <typename A>
  struct pointer_query_columns< ::PhuongPhapTLType, id_oracle, A >:
    query_columns< ::PhuongPhapTLType, id_oracle, A >
  {
  };

  template <>
  class access::object_traits_impl< ::PhuongPhapTLType, id_oracle >:
    public access::object_traits< ::PhuongPhapTLType >
  {
    public:
    ...
    struct image_type
    {
      // mPhuongPhapTLTypeId
      //
      char mPhuongPhapTLTypeId_value[12];
      ub2 mPhuongPhapTLTypeId_size;
      sb2 mPhuongPhapTLTypeId_indicator;
  ...
  template <>
  class access::object_traits_impl< ::PhuongPhapTLType, id_common >:
    public access::object_traits_impl< ::PhuongPhapTLType, id_oracle >
  {
  };
...
#include "PhuongPhapTLType-odb.ixx"

#include <odb/post.hxx>

#endif // PHUONG_PHAP_TLTYPE_ODB_HXX
