  ...
  create_schema (database& db, unsigned short pass, bool drop)
  {
      ...
      switch (pass)
      {
        ...
        case 2:
        {
          db.execute ("BEGIN\n"
                      ...
                      "  END;\n"
                      "  BEGIN\n"
                      "    EXECUTE IMMEDIATE 'DROP SEQUENCE \"NHOMTULIEU_FCSEQ\"';\n"
                      "  EXCEPTION\n"
                      "    WHEN OTHERS THEN\n"
    ...
    else
    {
      switch (pass)
      {
        case 1:
        {
          db.execute ("CREATE TABLE \"NHOMTULIEU\" (\n"
                      "  \"NHOMTULIEUID\" NUMBER(20) NOT NULL PRIMARY KEY,\n"
                      "  \"TENNHOMTULIEU\" NVARCHAR2(50) NULL)");
          db.execute ("CREATE SEQUENCE \"NHOMTULIEU_FCSEQ\"\n"
