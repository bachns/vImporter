...
#ifndef TY_LE_TYPE_ODB_HXX
#define TY_LE_TYPE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::TyLeType >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::TyLeType >
  {
    public:
    typedef ::TyLeType object_type;
    typedef ::std::shared_ptr< ::TyLeType > pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct query_columns< ::TyLeType, id_oracle, A >
  {
    // mTyLeTypeId
    //
    typedef
    ...
    static const mTyLeTypeId_type_ mTyLeTypeId;
    ...
    static const mLoaiTyLe_type_ mLoaiTyLe;
  ...
  template <typename A>
  const typename query_columns< ::TyLeType, id_oracle, A >::mTyLeTypeId_type_
  query_columns< ::TyLeType, id_oracle, A >::
  mTyLeTypeId (A::table_name, "\"TYLETYPEID\"", 0, 20);

  template <typename A>
  const typename query_columns< ::TyLeType, id_oracle, A >::mMa_type_
  query_columns< ::TyLeType, id_oracle, A >::
  mMa (A::table_name, "\"MA\"", 0, 200);

  template <typename A>
  const typename query_columns< ::TyLeType, id_oracle, A >::mLoaiTyLe_type_
  query_columns< ::TyLeType, id_oracle, A >::
  mLoaiTyLe (A::table_name, "\"LOAITYLE\"", 0, 20);

  template <typename A>
  const typename query_columns< ::TyLeType, id_oracle, A >::mMoTa_type_
  query_columns< ::TyLeType, id_oracle, A >::
  mMoTa (A::table_name, "\"MOTA\"", 0, 200);

  template <typename A>
  const typename query_columns< ::TyLeType, id_oracle, A >::mNguoiSuaId_type_
  query_columns< ::TyLeType, id_oracle, A >::
  mNguoiSuaId (A::table_name, "\"NGUOISUAID\"", 0, 20);

  template <typename A>
  const typename query_columns< ::TyLeType, id_oracle, A >::mNgayChinhSua_type_
  query_columns< ::TyLeType, id_oracle, A >::
  mNgayChinhSua (A::table_name, "\"NGAYCHINHSUA\"", 0);

  template <typename A>
  const typename query_columns< ::TyLeType, id_oracle, A >::mTrangThai_type_
  query_columns< ::TyLeType, id_oracle, A >::
  mTrangThai (A::table_name, "\"TRANGTHAI\"", 0, 1);

  template <typename A>
  struct pointer_query_columns< ::TyLeType, id_oracle, A >:
    query_columns< ::TyLeType, id_oracle, A >
  {
  };

  template <>
  class access::object_traits_impl< ::TyLeType, id_oracle >:
    public access::object_traits< ::TyLeType >
  {
    public:
    ...
    struct image_type
    {
      // mTyLeTypeId
      //
      char mTyLeTypeId_value[12];
      ub2 mTyLeTypeId_size;
      sb2 mTyLeTypeId_indicator;
      ...
      // mLoaiTyLe
      //
      char mLoaiTyLe_value[12];
      ub2 mLoaiTyLe_size;
      sb2 mLoaiTyLe_indicator;
  ...
  template <>
  class access::object_traits_impl< ::TyLeType, id_common >:
    public access::object_traits_impl< ::TyLeType, id_oracle >
  {
  };
...
#include "TyLeType-odb.ixx"

#include <odb/post.hxx>

#endif // TY_LE_TYPE_ODB_HXX
